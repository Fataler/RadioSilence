label day_1:
    ...
    show s at move_on_scene_show(xalign=1.0)
    pause 2.0
    $ S.name = "Товарищ сержант"

    E tired idle "Товарищ старший сержант, сталкивались ли Вы с подобными ситуациями за время службы?"
    S idle "Что-то не припоминаю.{w=0.1} Такие мелочи обычно незначительны и, как правило, о них даже не докладывают."
    S "Кажется, этот случай особый, раз заинтересовал старших!"
    S smile "О, и, Эхо...{w=0.1} Не стоит ко мне обращаться как \"товарищ старший сержант\"."
    S proud "Ты же не хочешь, чтобы враг узнал, кто в нашем отряде главный?{w=0.1} Это может повлечь за собой...{w} угрозу моей жизни."
    ...
    S smug "Именно, моя золотая Эхо!{w=0.1} Разве не гениальную вещь я придумал?"
    ...
    S proud "Дальновидность – не грех, а благословение природы.{w=0.1} Всегда планируй непредвиденные ситуации на сто шагов вперёд, чтобы быть наездником судьбы!"
    ...
    L half_closed surprised "Конечно...{w} с-{w=0.1}сейчас."
    ...
    L "А?{w=0.1} Вы про то, чтобы войти в г-{w=0.1}город?"
    S smile "Ага. А ты о чём подумал?"

    show l embarrassed with dissolve

    L "Нет, я ни о чём...{w=0.1} эм, просто..."
    ...
    N "Я уверена, что от всех нас просто хотели избавиться."
    ...
    N hands relief "Ну, как ты себя чувствуешь, Эхо?{w=0.1} Рассказывай."
