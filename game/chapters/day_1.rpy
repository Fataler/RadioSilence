label day_1:
    ...
    E_t surprised "Но с такими чудаками мне пришлось столкнуться впервые...{w} И ведь не упрекнёшь их."
    ...
    E_t surprised "...Он вполне мог этого не добавлять.{w=0.1} Но, кажется, его просто забавляет, как мы реагируем."
    ...
    E_t ear think "Значит, у него всё хорошо. {w=0.1} Переключаюсь на голосовую передачу с другим, но продолжаю принимать всех одновременно."
    ...
    E_t "Но весь ужас заключается в том, что я услышала её голос не в наушниках.{w} Он доносился из-за угла."
    E_t "Кажется, она не может нажать на рацию, потому что подняла руки вверх."
    E_t "Вопрос в том, сорвал ли противник с неё наушники.{w} Если нет, я могу ей передать, чтобы она отвлекла внимание..."
    ...
    E_t "Он прав...{w} На такой дальности это без проблем мог бы сделать только Леон-2, но не я."
    E_t ear asharashen "Мои размышления прервал крик."

    show n fear at angry with dissolve

    N "Почему ты не отвечаешь?!"
    E_t base annoyed "Будучи на волоске от смерти, Нектар начинает терять самообладание.{w} Нужно что-то делать."
    E_t tired surprised "...Погодите, почему нападающий никак не реагирует?{w=0.1} Он видит не только её, но и меня."
    ...
    N "Что такое?"
    E base annoyed "Ты никого не видишь...{w=0.1} вон там?"
    ...
    E_t tired idle "Он прав.{w=0.1} Нам действительно нужно доложить о входе в город."
    ...
    E_t annoyed "Даже если это война...{w} есть ли тут место для ненависти к товарищам?"
    ...
    E_t "Но я быстро отбросила эту мысль, потому что экран не показывал скачка в полосе частот.{w} Приборы не могут мне врать."
    E_t "Если человеческое ухо способно выделить голос человека среди шума, то это не может не отразить приёмник.{w} Будет разница в десятки децибел."
    ...
    E_t "Тем более когда мы вместе...{w} А?"
    ...
    E_t "Голоса не доходят до меня, потому что затухают в окружающей среде.{w} Но выполнить избирательность по направлению и усилить нужные частоты..."
    ...
    E_t "Есть!{w=0.1} Я что-то поймала на западе."
    ...
    E_t "Что-то не так."
    E_t "Почему я их слышу...{w} только через наушники?"
    ...
    E_t "Может, всё дело в многолучевом распространении?{w=0.1} Её голос, должно быть, отражается от стен и попадает на приёмник снова и снова."
    E ear asharashen "Хм..."
    E_t "Несмотря на очевидную близость к отряду, я не осмеливаюсь закричать, что я здесь."
    E_t "Почему?{w=0.1} Что не так?"
    ...
    E_t "Подождите.{w=0.1} Или не совсем?"
    ...
    E_t "Он где-то правее?{w=0.1} Или левее?"
    ...
    E_t tired surprised "Два двора?..{w} Мне казалось, я плутала вечность."
    ...
    E_t "Да сто процентов они мне не поверят.{w=0.1} Я бы и сама себе не поверила..."
    ...
    E_t surprised "Но...{w} должна ли я сама доверять себе? Теперь это всё кажется каким-то сном."
    ...
    N "Я выжила.{w=0.1} Я справилась с теми, кто разрушал мою жизнь."
    ...
    E_t tired idle "Есть ли у меня такие люди в жизни?{w=0.1} Или я сама по себе..."
    E_t "Я не знаю.{w=0.1} Сложно сказать, но, наверное...{w} второе."
    ...
    E_t surprised "Справлюсь ли я с безумием, когда оно настигнет меня?{w} Я не знаю..."
    ...
    E_t tired surprised "Точно!{w=0.1} Я не одна столкнулась со странностями."
    E_t "Неужели...{w} с верой в Стального я начинаю обретать веру в себя?{w=0.1} Мне всё это не привиделось?"
    E_t "Я чувствую желание Стального верить в наш отряд.{w=0.1} Он не испытывал того же, что я и Леон-2, но глубоко внутри он понимает, что мы ему не врём."
    ...
    E_t surprised "Интересно, спит ли он вообще?{w=0.1} И когда это происходит?"
    ...
    E_t tired idle "Через некоторое время я начала клевать носом.{w=0.1} Сегодня был тяжёлый день."
