label day_1:
    ...
    S "Что-то не припоминаю.{w=0.1} Такие мелочи обычно незначительны и, как правило, о них даже не докладывают."
    ...
    S "Дальновидность – не грех, а благословение природы.{w=0.1} Всегда планируй непредвиденные ситуации на сто шагов вперёд, чтобы быть наездником судьбы!"
    hide s
